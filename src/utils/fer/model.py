...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=7, dropout=0.5, init_weights=True):
        super(VGG, self).__init__()
        self.features = self.make_layers(cfg[features])
...
class GoogLeNet(nn.Module):
    ...
    def __init__(self, num_classes=7, aux_logits=False, transform_input=False, init_weights=True):
